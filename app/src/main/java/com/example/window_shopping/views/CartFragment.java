...
import com.example.window_shopping.adapters.CartListAdapter;
import com.example.window_shopping.databinding.FragmentCartBinding;
...
public class CartFragment extends Fragment implements CartListAdapter.CartInterface {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        shopViewModel.getTotalPrice().observe(getViewLifecycleOwner(), new Observer<Integer>() {
            @Override
            public void onChanged(Integer aDouble) {
                fragmentCartBinding.orderTotalTextView.setText("Total Price: Rp " + aDouble.toString());
            }
        });
