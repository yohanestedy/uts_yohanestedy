...
import com.example.window_shopping.adapters.ShopListAdapter;
...
public class ShopFragment extends Fragment implements ShopListAdapter.ShopInterface {
    ...
    public void AddItem(Product product) {
        ...
        if (isAdded){
            Snackbar.make(requireView(), product.getName() + " ditambahkan ke keranjang.", Snackbar.LENGTH_LONG).setAction("Checkout", new View.OnClickListener() {
                @Override
